        ...
        link: function(scope, element, attrs, ngModelCtrl) {
            ...
            for (row = _i = 0, _ref = numRows - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; row = 0 <= _ref ? ++_i : --_i) {
              ...
              for (day = _j = 0; _j <= 6; day = ++_j) {
                ...
                weeks[row].push({
                  date: d,
                  selected: selected,
                  disabled: (typeof scope.dateFilter === 'function' ? !scope.dateFilter(d) : false) || (scope.disableOther && d.getMonth() !== scope.calendarDate.getMonth()) || (scope.minDate && d < scope.minDate) || (scope.maxDate && d > scope.maxDate),
          ...
          ngModelCtrl.$parsers.push(function(viewVal) {
            ...
            if (scope.required && (viewVal == null)) {
              ...
              value = scope.parseDateFunction(viewVal);
            }
            if (scope.minDate && scope.minDate > viewVal) {
              validity.minDate = false;
            }
            if (scope.maxDate && scope.maxDate < viewVal) {
          ...
          ngModelCtrl.$formatters.push(function(modelVal) {
            if (scope.minDate && scope.minDate > modelVal) {
              void 0;
            }
            if (scope.maxDate && scope.maxDate < modelVal) {
              void 0;
            }
          ...
          scope.$watch('minDate', function(newVal, oldVal) {
            if (newVal && ngModelCtrl.$modelValue < newVal) {
          ...
          scope.selectDate = function(date, closeCalendar, disabled) {
            var changed;
